...
val captchaTempStorageDir = if (isProd) "/root/guutt/captchas" else "src/main/kotlin/authorization_feature/guu/temp_captchas"
val unsolvedCaptchaDir = if (isProd) "/root/guutt/unsolved_captcha" else "C:\\Users\\ilyap\\Documents\\TesseractUnsolvedCaptcha"

val tessdataDir = if (isProd) "/root/guutt/tessdata" else "src/main/kotlin/tesseract/tessdata"